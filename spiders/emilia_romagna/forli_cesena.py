...
def run(url_visti):
    risultati = []
    print("    Inizio scraping Provincia di Forlì-Cesena (USR ER - Interpelli)...")

    url_base = "https://fc.istruzioneer.gov.it/category/interpelli-a-s-2025-26/"
    ...
    try:
        ...
        if resp.status_code != 200:
            print(f"    ⚠️ Errore USR Forlì-Cesena, status code: {resp.status_code}")
            return risultati
        ...
        print(f"    ⚠️ Errore durante lo scraping di Forlì-Cesena: {e}")
