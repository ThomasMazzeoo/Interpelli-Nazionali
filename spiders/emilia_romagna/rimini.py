...
def run(url_visti):
    risultati = []
    print("    Inizio scraping Provincia di Rimini (USR ER - Interpelli)...")

    url_base = "https://rn.istruzioneer.gov.it/category/personale-docente/interpelli-docenti-2025-2026/"
    ...
    try:
        ...
        if resp.status_code != 200:
            print(f"    ⚠️ Errore USR Rimini, status code: {resp.status_code}")
            return risultati
        ...
        print(f"    ⚠️ Errore durante lo scraping di Rimini: {e}")
