...
def run(url_visti):
    risultati = []
    print("    Inizio scraping Provincia di Nuoro (USR Sardegna - Interpelli)...")

    url_base = "https://www.mim.gov.it/web/nuoro/interpelli"
    ...
    try:
        ...
        if resp.status_code != 200:
            print(f"    ❌ Errore USR Nuoro, status code: {resp.status_code}")
            return risultati
        ...
        print(f"    ❌ Errore durante lo scraping di Nuoro: {e}")
