...
def run(url_visti):
    risultati = []
    print("    Inizio scraping Provincia di Sassari (USR Sardegna - Interpelli)...")

    url_base = "https://www.mim.gov.it/web/sassari/interpelli-docenti"
    ...
    try:
        ...
        if resp.status_code != 200:
            print(f"    ❌ Errore USR Sassari, status code: {resp.status_code}")
            return risultati
        ...
        print(f"    ❌ Errore durante lo scraping di Sassari: {e}")
