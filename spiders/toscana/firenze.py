...
def run(url_visti):
    risultati = []
    print("    Inizio scraping Provincia di Firenze (USR Toscana - Interpelli)...")

    url_base = "https://www.ust.fi.it/mese/interpelli/"
    ...
    try:
        ...
        if resp.status_code != 200:
            print(f"    ❌ Errore USR Firenze, status code: {resp.status_code}")
            return risultati
        ...
        print(f"    ❌ Errore durante lo scraping di Firenze: {e}")
