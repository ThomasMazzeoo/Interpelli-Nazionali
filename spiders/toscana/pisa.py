...
def run(url_visti):
    risultati = []
    print("    Inizio scraping Provincia di Pisa (USR Toscana - Interpelli)...")

    url_base = "https://www.usp-pi.it/category/interpelli/"
    ...
    try:
        ...
        if resp.status_code != 200:
            print(f"    ❌ Errore USR Pisa, status code: {resp.status_code}")
            return risultati
        ...
        print(f"    ❌ Errore durante lo scraping di Pisa: {e}")
